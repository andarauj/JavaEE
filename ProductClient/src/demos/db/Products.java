...
@NamedQueries({
    ...
    @NamedQuery(name = "Products.findByName", query = "SELECT p FROM Products p WHERE p.name like :name"),
    @NamedQuery(name = "Products.findTotal", query = "SELECT count(p.id),sum(p.price) FROM Products p WHERE p.id in  :ids"),
    @NamedQuery(name = "Products.findByPrice", query = "SELECT p FROM Products p WHERE p.price = :price"),
    @NamedQuery(name = "Products.findByBestBefore", query = "SELECT p FROM Products p WHERE p.bestBefore = :bestBefore"),
